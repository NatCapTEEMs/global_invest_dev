...
| water_use | {{< meta water_use_gep >}} irrigation, from a {{< meta water_use_premium_gross >}} premium | no. The drive's two committed figures were produced separately, so neither is a reference |
