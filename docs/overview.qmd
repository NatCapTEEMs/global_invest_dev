...
- **Q4:** is there a CWoN timber rent, and where? Switching timber onto the convention the rest of the account uses is not a configuration change. No CWoN timber rent is staged anywhere in our base data. What we hold covers crop, livestock, fisheries, renewable energy, extractive energy and non-wood forest products, and the non-wood file is a different quantity from timber.
