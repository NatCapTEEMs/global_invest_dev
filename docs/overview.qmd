...
- Reading a published value opens a file and reshapes it. Rescaling turns a published rate into dollars. Table arithmetic multiplies a quantity, a price and an attribution. Raster arithmetic reaches the value by processing grids. A process model has dynamics of its own, sediment routing for erosion, slope stability for landslides, a gravity model for recreation.
