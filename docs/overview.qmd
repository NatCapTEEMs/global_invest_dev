...
poll_raster: "$387.49bn"
poll_with_sufficiency: "$163.33bn"
poll_fao: "$515bn"
livestock_ind: "$136bn"
...
- **Q2:** why does the reference leave 17 countries empty although the CWoN table values them? We now report 97, and carry the 95-country variant beside it as the comparison, so the {{< meta water_supply_anchor >}} anchor still checks out.
...
- [The current outputs are the v2_2024hazard pair the author named, `flood_gep_for_merge_v2_2024hazard.csv` to join against the other services and `flood_gep_country_results_v2_2024hazard.csv` for the full account, superseding FINAL_GEP_FLOOD.]{.state}
