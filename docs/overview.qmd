...
- **Q1:** should the EPS-5 sensitivity be reported beside the baseline? It relaxes the severity threshold from 11 t/ha/yr to 5 and takes the reported figure from {{< meta erosion_author_ses11 >}} to {{< meta erosion_author_eps5 >}}.
