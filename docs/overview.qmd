...
- Ten of the eleven services carry their GEP valuation in the library; fisheries' is still external. Whether each number is verified, provisional, or quarantined is the per-service story below. Services whose science supports it also produce a scenario shock for the macroeconomic pipeline; not all can be made into shocks.
...
| landslide_mitigation | first full run in progress | no machine-readable reference yet |
