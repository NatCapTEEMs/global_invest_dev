...
- [Values the hypertension treatment cost urban greenspace avoids: prevalence times the NDVI-driven risk reduction times the urban population aged 30-79, at the country's published cost per case. Built here end to end: {{< meta health_hypertension_gep >}} over the 20 countries with a cost study, matching the appendix's {{< meta health_hypertension_appendix >}} at rank correlation 0.989 and 42 percent above its level on the named deviations.]{.state}
...
- **Q3:** is the cost transfer the account's route to full coverage? Transferring the 20 studied costs on GDP per capita (R2 0.32, observed studies kept) extends the row to {{< meta health_hypertension_extended >}} over 187 countries.
