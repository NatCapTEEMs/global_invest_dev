...
- [Where that leaves the comparison: ours is {{< meta erosion_total >}} against your {{< meta erosion_author_ses11 >}}, within about four percent, while China sits thirty percent higher in ours, India nearly thirty lower and the Philippines forty higher. A country's area is now the sum of the territories the boundary file splits it into, rather than any one of them: taking a single territory's area let China and India qualify as small and draw the lower soil-loss tolerance, which counts far more of their cropland as severely eroding, and seven countries moved. The figures above come from a run that predates that change, and the rerun will restate them.]{.state}
