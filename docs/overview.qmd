...
- [Values non-timber forest products over the forest that is within 10 km of a road or river and green enough to yield one. {{< meta ntfp_total >}} across 208 countries. The pipeline is the source module's: the land cover at its native 300 m in Mollweide, a five-year mean NDVI screen, and accessibility as the dissolved buffer of the road and river geometries rather than a raster dilation.]{.state}
