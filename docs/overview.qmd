...
- [Values non-timber forest products over the forest within 10 km of a road or river. $28.87bn across 142 countries. The CWoN value is now spread over the forest people can reach rather than over all of it, which raises the rate and leaves the country total at CWoN's own.]{.state}
- **Q1:** is there a model behind CWoN's non-wood forest product value, or is it a published table? Since the reachable hectares cancel, that is all that stands between this service and a number we compute.
## stormwater
