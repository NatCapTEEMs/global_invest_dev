...
- **Q3:** is the agriculture gap the missing water-stress attribution? We compute withdrawal times AQUASTAT efficiency, the gross value of water used rather than the part attributable to ecosystems, which would explain why the agriculture pair is {{< meta water_use_ag_total >}} against $554.5bn while the all-sector pair agrees closely.
