...
fisheries_aquaculture_total: "$110.50bn"
...
| water_use | {{< meta water_use_ag_total >}} irrigation and {{< meta water_use_domestic_total >}} domestic, {{< meta water_use_all_total >}} all sectors | no. The drive's two committed figures were produced separately, so neither is a reference |
