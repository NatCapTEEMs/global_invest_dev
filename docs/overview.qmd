...
- Every service produces a GEP valuation per country (fisheries' is the one not in the library yet). Services whose science supports it also produce a scenario shock for the macroeconomic pipeline; not all can be made into shocks.
