...
| {{< meta n_not_wired >}} | No number yet. Each is waiting on a model run, named on its own slide. |
...
- {{< meta n_reports >}} of the {{< meta n_with_a_run >}} services with a run have rendered their report.
