...
- initialize_paths resolves every input a service needs, in one place: the code names what it needs relative to the shared base data, and each machine finds its own copy.
