...
- **Q1:** which definition does the account want? The crop output at stake if pollinators vanished, or the service habitat currently delivers. On the author's raster it comes to {{< meta poll_author_raster >}} without habitat sufficiency, and {{< meta poll_with_sufficiency >}} once the 300 m sufficiency is multiplied in, on one grid at 2019 prices. Only the second responds to land-use change; the first is a property of the crop mix. The account reports {{< meta poll_raster >}} on our own raster, and the sufficiency-weighted counterpart on that raster has not been run.
