...
The analysis reveals that terrestrial carbon storage and sequestration generates a total gross ecosystem product of $`{python} f"{total_terrestrial_carbon_value:,.2f}"` in the base year (2019). Below we present the results in various aggregations, ending with the GEP by country in the base year.
