...
def gep_calculation(p):
    ...
    p.results['coastal_carbon']['gep_by_country_year'] = os.path.join(
        p.cur_dir, "gep_by_country_year.csv"
    )
    p.results['coastal_carbon']['gep_by_year'] = os.path.join(
        p.cur_dir, "gep_by_year.csv"
    )
