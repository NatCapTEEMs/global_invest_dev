...
if __name__ == "__main__":
    data_dir = "G:/Shared drives/NatCapTEEMs/Files/base_data/global_invest/commercial_agriculture/input"
    result = calculate(data_dir)
    ...
    print(f"Total GEP in base year 2019 using input data: {gep}")
