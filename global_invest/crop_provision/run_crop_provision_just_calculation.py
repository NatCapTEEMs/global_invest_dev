...
if __name__ == '__main__':
    ...
    # Task tree
    crop_provision_initialize.build_gep_service_calculation_task_tree(p) # Defines the actual logic of the model. Navigate into here to see what the model does.
