...
if __name__ == '__main__':
    ...
    p.project_name = 'gep_crop_provision'  # Determines the folder created to store intermediate and final results.
    ...
    # Task tree
    crop_provision_initialization.build_gep_service_calculation_task_tree(p) # Defines the actual logic of the model. Navigate into here to see what the model does.
    ...
    crop_provision_initialization.initialize_paths(p)
