...
if __name__ == '__main__':    
    """Full gep calculation and reporting on renewable energy production."""
    
    # ProjectFlow setup
    p = hb.ProjectFlow() # Create a ProjectFlow Object to organize directories and enable parallel processing.
    p.project_name = 'gep_renewable_energy_production'  # Determines the folder created to store intermediate and final results.
    ...
    # Task tree
    renewable_energy_production_initialization.build_gep_service_task_tree(p) # Defines the actual logic of the model. Navigate into here to see what the model does.
    ...
    renewable_energy_production_initialization.initialize_paths(p)
