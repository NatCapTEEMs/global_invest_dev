...
if __name__ == '__main__':    
    ...
    p.project_name = 'gep_renewable_energy_provision'  # Determines the folder created to store intermediate and final results.
    ...
    # Task tree
    renewable_energy_provision_initialization.build_gep_service_task_tree(p) # Defines the actual logic of the model. Navigate into here to see what the model does.
    ...
    renewable_energy_provision_initialization.initialize_paths(p)
