---
title: "Overview of Ecosystem Service: Carbon Sequestration"
format:
  aps-pdf:
    keep-tex: true
    toc: false
...
![Workflow for quantifying the global carbon sequestration. (a) The Data Preparation phase integrates the carbon zone map employed by @gibbs2008new, global ESA LULC data for 2010, and carbon density data from Spawn et al. (2020) to generate a carbon density lookup table.
...
$$
\text{GEP}_{\text{carbon\_sequestration}} = Q \cdot P \cdot \lambda= \text{Carbon Storage} \times \text{Rental SCC} \times 1
$$
