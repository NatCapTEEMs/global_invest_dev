...
if __name__ == '__main__':
    ...
    p.base_data_dir = "/Users/long/Library/CloudStorage/GoogleDrive-yxlong@umn.edu/Shared drives/NatCapTEEMs/Files/base_data/submissions" # Set where data outside the project will be stored.
    ...
    p.base_year = 2019
    p.refresh_world_bank_inputs = True  # Try API first; local base-data files remain the fallback.
