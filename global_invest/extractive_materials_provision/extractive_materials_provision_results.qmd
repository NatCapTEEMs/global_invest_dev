...
The analysis reveals that total extractive materials provision value generates a total gross economic product of $`{python} f"{total_extractive_materials_provision_value:,.2f}"` across the study period. Below we present the results in various aggregations, ending with the GEP by country in the base year.
