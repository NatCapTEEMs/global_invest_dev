...
The analysis reveals that costal protection generates a total gross economic product of $`{python} f"{total_value:,.2f}"` across the study period. Below we present the results in various aggregations, ending with the GEP by country in the base year.
