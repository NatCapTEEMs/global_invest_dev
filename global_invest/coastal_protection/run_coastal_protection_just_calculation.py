...
if __name__ == '__main__':
    ...
    # Task tree
    coastal_protection_initialization.build_gep_service_calculation_task_tree(p) # Defines the actual logic of the model. Navigate into here to see what the model does.
    ...
    coastal_protection_initialization.initialize_paths(p)
