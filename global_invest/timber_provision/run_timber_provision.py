"""Full timber_provision GEP run: the committed valuation -> report.
...
def build_task_tree(p):
    ...
    timber_provision_initialize.build_gep_service_task_tree(p)
...
if __name__ == '__main__':
    ...
    p = hb.ProjectFlow(project_name='gep_timber_provision', run_mode='check')
